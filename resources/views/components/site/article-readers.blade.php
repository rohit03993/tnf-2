...
<div
    id="tnf-article-read-tracker"
    class="tnf-article-readers"
    data-read-url="{{ route('article.read', $article) }}"
    aria-live="polite"
>
    <svg class="tnf-article-readers__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <p class="tnf-article-readers__text">
        <span data-article-readers>{{ \App\Services\ArticleReadService::formatCount($readersCount) }}</span>

...
<div {{ $attributes->merge(['class' => 'tnf-share-bar']) }}>
    <span class="mr-2 text-tnf-sm font-semibold text-tnf-navy">Share:</span>

    <a href="https://www.facebook.com/sharer/sharer.php?u={{ $encodedUrl }}" target="_blank" rel="noopener"
       class="tnf-share-btn tnf-share-btn--facebook" aria-label="Share on Facebook">
    ...
    <a href="https://wa.me/?text={{ $encodedTitle }}%20{{ $encodedUrl }}" target="_blank" rel="noopener"
       class="tnf-share-btn tnf-share-btn--whatsapp" aria-label="Share on WhatsApp">
    ...
    <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ $encodedUrl }}" target="_blank" rel="noopener"
       class="tnf-share-btn tnf-share-btn--linkedin" aria-label="Share on LinkedIn">
    ...
    <a href="https://twitter.com/intent/tweet?url={{ $encodedUrl }}&text={{ $encodedTitle }}" target="_blank" rel="noopener"
       class="tnf-share-btn tnf-share-btn--x" aria-label="Share on X">
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
    </a>

    <button type="button" class="tnf-share-btn tnf-share-btn--copy tnf-share-copy"
        data-copy-url="{{ $shareUrl }}" aria-label="Copy link">
        <svg class="tnf-share-copy-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/>
        </svg>
        <svg class="tnf-share-copied-icon hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
        </svg>
    </button>

    <button type="button" class="tnf-share-btn tnf-share-btn--native tnf-share-native hidden"
